...
class FileButton extends StatefulWidget{
  FileButton({super.key, required this.fsEntity, required this.openFile, required this.doOnFile, required this.setMode, required this.getMode, required this.selectionList}) : name = fsEntity.path.split('/').last;
    ...
    return MaterialButton(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          SafeArea(
            child: FileOptionsMenu(selected: List.of([widget]), doOnFile: widget.doOnFile)
          )
        ],
      ),
    );
